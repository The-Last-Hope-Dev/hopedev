...
export default function Alert({ alertType, message }) {
    ...
    const [alertStyle, setAlertStyle] = useState(alertType || "");
    ...
    const renderAlert = () => {
        switch (alertStyle) {
            case AlertTypes.WARNING:
                return <div className="alert alert-warning shadow-lg">
                    <div>
                        ...
                        <span>Warning {alertMessage}</span>
                    </div>
                </div>
            ...
            default:
                return <div className="alert shadow-lg bg-base-100 ">
                    <div>
    ...
    useEffect(() => {
        isMobile ? setAlertMessage("") : setAlertMessage(message);
